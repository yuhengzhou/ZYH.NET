<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckBoxList_Test.aspx.cs" Inherits="Tester_ZYH.NET_V.Test_V.CheckBoxList_Test" %>
...
<body>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="javascript:Fill_CheckBoxList1('5');">Fill CheckBoxList</asp:HyperLink>
    <br />
    <br />
